        ...
        <section id="about" class="py-20 scroll-reveal">
            <div class="grid md:grid-cols-3 gap-12 items-center">
                <div class="md:col-span-1">
                    <img src="https://images.unsplash.com/photo-1516557070065-84e8d8b4c533?q=80&w=1887&auto=format&fit=crop" alt="Фото Никиты Амброси" class="rounded-full mx-auto w-48 h-48 md:w-64 md:h-64 object-cover shadow-lg">
                </div>
